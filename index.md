...
<body>
    <div class="container">
        ...
        <div class="text">
            ...
            <p style="color: black; font-size: 15px;">Data Scientist, Machine Learning Student & Physisist</p> 
...
<body>
    <section>
        <h4 style="text-align:center; color:maroon;"><span class="background">Probability and Statistics</span></h4>
    </section>
</body>
<hr>
...
<div class="container" style="transform:TranslateX(-150px);">
    ...
    <div class="image-block">
      ...
      <figure>
        <figcaption class="figure-title"><strong>Introduction to Statistics in Python</strong><span style="font-size: 15px; color:grey;"> (Sampling, Variables in Statistics, Frequency Distribution, Visualization & Comparison of Frequency Distribution)</span></figcaption>
     ...
     <div class="container" style="transform:TranslateX(-20px);">
     ...
     <div class="image-block">
      ...
      <figure>
        ...
        <a href="https://github.com/bshreeks/Dataquest-Statistics-and-Probability/blob/main/Building_SpamFilter_with_BayesAlgorithm.ipynb" target="_blank">
     ...
     <div class="image-block">
      ...
      <figure>
        <figcaption class="figure-title"><strong>Hypothesis Testing in Python</strong><span style="font-size: 15px; color:grey;"> (Significance Testing, Chi-Squared Testing, Assessing p-value, Multi-category Chi-Squared Tests)</span></figcaption>
        <a href="https://github.com/bshreeks/Dataquest-Statistics-and-Probability/blob/main/Winning_Jeopardy.ipynb" target="_blank">
        <img src="/assets/images/joepardy.jpg" alt="spam_logo" style="width: 250px; height: 200px;">
        </a>
