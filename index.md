...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Projects Side by Side</title>
    <style>
        /* Container for both projects */
        .projects-container {
            display: flex; /* Enables side-by-side alignment */
            justify-content: space-between; /* Keeps space between projects */
        ...
        .project {
            ...
            width: 48%; /* Ensures two projects fit in one row */
            background-color: #f9f9f9; /* Light background for visibility */
            padding: 15px;
            border-radius: 8px;
            box-shadow: 2px 2px 10px rgba(0, 0, 0, 0.1); /* Soft shadow for effect */
        }
    ...
    <div class="projects-container">
        ...
        <div class="project">
            <a href="https://github.com/bshreeks/dataquest_projects/blob/main/App_Profile.ipynb" target="_blank">
                <img src="/assets/images/AppStore.jpg" alt="App Store Project">
            </a>
            <div class="text">
                <p><strong>Profitable App Profiles for the Apple Store and Google Play Markets</strong></p>
                <p><i>In this project, we analyzed app data to determine profitable app categories for free apps that rely on in-app ads.</i></p>
            </div>
        </div>

        <!-- Project 2 -->
        <div class="project">
            <a href="https://github.com/bshreeks/dataquest_projects/blob/main/AnotherProject.ipynb" target="_blank">
                <img src="/assets/images/AnotherProject.jpg" alt="Another Project">
            </a>
            <div class="text">
                <p><strong>Another Data Science Project</strong></p>
                <p><i>This project focuses on exploring data trends and insights using Python and machine learning techniques.</i></p>
            </div>
        </div>
    </div>
</body>
